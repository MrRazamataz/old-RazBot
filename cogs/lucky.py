...
class lucky(commands.Cog):
    ...
    async def command_lucky(self, ctx: commands.Context):
        if ctx.author.guild_permissions.administrator:
            m = await ctx.channel.send("OO yay a giveaway, my favourite thing to do. It's always fun to do. \nAnyway, just react to the message with my reaction I have added and wait, it's as easy as that!")
            ...
            await ctx.channel.send(
                f"You have won! How very lucky of you! :). Now wait for <@{ctx.author.id}> to notice and he will give you your prize!")
